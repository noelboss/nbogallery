 ...
 */
abstract class Tx_Nbogallery_Core_ViewHelper_AbstractViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	/**
	 * @var Tx_Nbogallery_Service_Json
	 */
	protected $jsonService;

	/**
	 * @var Tx_Nbogallery_Utility_DocumentHead
	 */
	protected $documentHead;

	/**
	 * @var Tx_Nbogallery_Utility_ExtJS
	 */
	...
	/**
	 * Inject JSON Service
	 * @param Tx_Nbogallery_Service_Json $service
	 */
	public function injectJSONService(Tx_Nbogallery_Service_Json $service) {
		$this->jsonService = $service;
	}

	/**
	 * @param Tx_Nbogallery_Utility_DocumentHead $documentHead
	 */
	public function injectDocumentHead(Tx_Nbogallery_Utility_DocumentHead $documentHead) {
		$this->documentHead = $documentHead;
	}

	/**
	 * @param Tx_Nbogallery_Utility_ExtJS $extJSService
	 */
	public function injectExtJSService(Tx_Nbogallery_Utility_ExtJS $extJSService) {
